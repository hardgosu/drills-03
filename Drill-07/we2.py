...
def draw_curve_2_points(p1,p2):
    draw_big_point(p1)
    draw_big_point(p2)
    for i in range(0, 100 + 1, 2):
        t = i / 100
        x = (1 * t + 1) * p1[0] + (1 * t) * p2[0]
        y = (1 * t + 1) * p1[1] + (1 * t) * p2[1]
        draw_point((x, y))
    draw_point(p2)
    pass
...
def draw_curve_4_pointsNew(p1, p2, p3, p4):
    draw_big_point(p1)
    draw_big_point(p2)
    draw_big_point(p3)
    draw_big_point(p4)
...
#draw_curve_2_points(points[0],points[1])
draw_curve_4_points(points[0],points[1],points[2],points[3])
#draw_curve_4_points(points[3],points[0],points[1],points[2])
