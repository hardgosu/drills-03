...
class Boy:
    ...
    def get_bb(self):
        #return self.canvas_width//2 - 10, self.canvas_height//2 - 10, self.canvas_width//2 + 10, self.canvas_height//2 + 10
    ...
    def draw(self):
        ...
        self.font.draw(self.x - self.bg.window_left - 25, self.y - self.bg.window_bottom + 75, '(%5d)' % (self.numberOfEatenBall),(255, 0, 255))
        self.draw_bb()
